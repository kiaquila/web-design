...
export const experiences: MenuItem[] = [
  item(
    ...
    c(
      ...
      "Авторский сет: хумус с хлебом, самса с бараниной, самса по-татарски, хрустящие баклажаны, салат «Ташкент», ассорти манты (3 вида), люля-кебаб из баранины, узбекский плов и пахлава.",
    ),
  ...
  item(
    ...
    undefined,
    c(
      "Ensalada Olivier, bliny con caviar rojo, encurtidos para acompañar con vodka, borscht, bifstroganov, vareniki con papa y medovik.",
      "Olivier salad, bliny with red caviar, traditional pickles, borscht, beef stroganoff, potato vareniki and medovik.",
      "Салат оливье, блины с красной икрой, соленья под водку, борщ, бефстроганов, вареники с картофелем и медовик.",
    ),
    c("Cocina rusa", "Russian table", "Русская кухня"),
    undefined,
    [
      { label: c("Experiencia", "Experience without wine", "Сет без вина"), price: "169 000" },
...
export const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      item(c("Costillas de cordero", "Lamb ribs", "Бараньи рёбра"), "89 900", c("Marinadas en especias y cocinadas a las brasas. 1,2 kg.", "Spice-marinated and charcoal-grilled. 1.2 kg.", "Выдержанные 14 часов в sous-vide и обжаренные на мангале. 1,2 кг."), c("Más pedidos", "Guest favourite", "Популярное")),
