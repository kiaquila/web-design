...
export type LocalizedValue = string | Copy;
...
export const pickLocalized = (value: LocalizedValue, lang: Lang) =>
  Array.isArray(value) ? pick(value, lang) : value;
...
export const experiences: MenuItem[] = [
  item(
    ...
    undefined,
    c(
      "Presentación de autor con 8 platos, pensada para dos: hummus con pan, samsa de cordero, samsa Tatarstan, berenjena crocante, ensalada Tashkent, manti surtidos (3 tipos), lula kebab de cordero, plov uzbeko y baklava.",
      "A signature eight-course presentation for two: hummus with bread, lamb samsa, Tatarstan samsa, crispy eggplant, Tashkent salad, three assorted manti, lamb lula kebab, Uzbek plov and baklava.",
      "Авторский сет на двоих: хумус с хлебом, самса с бараниной, самса по-татарски, хрустящие баклажаны, салат «Ташкент», ассорти манты (3 вида), люля-кебаб из баранины, узбекский плов и пахлава.",
    ),
    c("Para dos", "For two", "На двоих"),
    c(
      "La forma ideal de descubrir la cocina de Chaijaná",
      "The ideal introduction to the world of Chaijaná",
      "Идеальное знакомство с кухней Chaijaná",
    ),
    [
      { label: c("Con vino (2 copas) St. Felicien Malbec", "With 2 glasses of St. Felicien Malbec", "Два бокала вина St. Felicien Malbec"), price: "159 000" },
      { label: c("Con té tradicional", "With tea", "С чаем масала"), price: "139 000" },
    ],
  ),
  item(
    ...
    undefined,
    c(
      "Peso final del plato: 2,2 kg de carne. Mollejas a las brasas, brochette de corazón, lula kebab de cordero, shashlik de ojo de bife y costillas de cordero a las brasas.",
      "Final dish weight: 2.2 kg of meat. Grilled sweetbreads, beef heart skewer, lamb lula kebab, ojo de bife shashlik and charcoal-grilled lamb ribs.",
      "Вес ассорти: 2,2 кг мяса. Зобная железа телёнка на углях, стейк из сердца, люля-кебаб из баранины, шашлык из охо де биф и рёбра барашка.",
    ),
    c("Al fuego", "From the fire", "На огне"),
    undefined,
    [
      { label: c("Experiencia sin vino", "Experience without wine", "Сет без вина"), price: "169 000" },
      { label: c("Con botella St. Felicien Malbec 750 ml", "With a bottle of St. Felicien Malbec 750 ml", "С бутылкой St. Felicien Malbec 750 мл"), price: "185 000" },
    ],
  ),
  item(
    ...
    undefined,
    c(
      "Ensalada Olivier, bliny con caviar rojo, encurtidos para acompañar con vodka, sopa borscht, bifstroganov, vareniki con papa y torta medovik.",
      "Olivier salad, blini with red caviar, pickles served with vodka, borscht, beef stroganoff, potato vareniki and medovik cake.",
      "Салат оливье, блины с красной икрой, закуска под водочку (соленья), суп борщ, бефстроганов, вареники с картошкой и торт медовик.",
    ),
...
export const menuSections: MenuSection[] = [
  {
    ...
    intro: c("Una mañana contundente con acento oriental", "A hearty morning with an eastern touch", "Сытное утро с восточным акцентом"),
    items: [
      ...
      item(c("Shakshuka", "Shakshuka", "Шакшука"), "20 000", c("Huevos al horno en una rica salsa de tomate, morrón dulce y berenjena, acompañados con pan de cebolla recién horneado.", "Oven-baked eggs in a fragrant tomato, sweet pepper and eggplant sauce, served with freshly baked onion bread.", "Запечённая в печи яичница в ароматном соусе из томатов, сладкого перца и баклажанов, подаётся с луковым хлебом."), c("Especial del Chef", "Chef's special", "От шефа")),
      item(c("Syrniki", "Syrniki", "Сырники"), "15 000", c("Syrniki de ricota con crema agria, frutos rojos y banana.", "Curd syrniki with sour cream, berries and banana.", "Творожные сырники со сметаной, ягодами и бананом."), c("Más pedidos", "Popular", "Популярное")),
  ...
  },
  {
    ...
    items: [
      item(c("Ensalada Olivier", "Olivier salad", "Салат оливье"), "20 000", c("Con pollo o carne hervida a elección, papa, zanahoria, pepinos en conserva y arvejas, con mayonesa casera.", "With your choice of chicken or boiled beef, potato, carrot, pickles and green peas, dressed with homemade mayonnaise.", "С курицей или отварной говядиной на выбор, картофелем, морковью, солёными огурцами и горошком, заправленный домашним майонезом."), c("Especial del Chef", "Chef's special", "От шефа")),
      ...
      item(c("Berenjenas crocantes", "Crispy eggplant", "Хрустящие баклажаны"), c("18 000", "16 000", "18 000"), c("Berenjenas en tempura con tomates, albahaca y salsa agridulce.", "Tempura eggplant with tomatoes, basil and sweet-and-sour sauce.", "Баклажаны в темпуре с томатами, базиликом и кисло-сладким соусом."), c("Más pedidos", "Popular", "Популярное")),
      ...
      item(c("Acompañar con vodka", "To pair with vodka", "Под водочку"), "17 000", c("Tabla de encurtidos tradicionales: chucrut, pepinos en salmuera, ajíes en vinagre y pan negro.", "Assorted pickles: sauerkraut, traditional barrel cucumbers, marinated peppers and black bread.", "Ассорти солений: квашеная капуста, бочковые огурчики, маринованный перец и чёрный хлеб."), undefined, c("Ideal para maridar con bebidas espirituosas", "Perfect with strong spirits", "Идеально к крепкому алкоголю")),
    ],
  },
  {
    id: "horno",
    title: c("Del horno", "From the oven", "Из печи"),
    intro: c("Pan y aperitivos recién horneados", "Hot pastries, bread and oven-baked appetizers", "Горячая выпечка, хлеб и закуски из печи"),
    items: [
      ...
      item(c("Para acompañar con pan", "To accompany bread", "К хлебу"), undefined, c("Probá nuestros panes con dips o pesto.", "Try our breads with a spread or pesto.", "Попробуйте наш хлеб с намазкой или песто."), undefined, undefined, [
        { label: c("Dip de ricota", "Cream cheese spread", "Творожная намазка"), price: "3 000" },
        { label: c("Salsa pesto", "Pesto sauce", "Соус песто"), price: "3 000" },
      ]),
    ],
  },
  {
    ...
    items: [
      item(c("Sopa de pescado", "Chef’s fish soup", "Уха от шефа"), "26 000", c("Sopa cremosa de salmón con papas y eneldo.", "Creamy salmon soup with potatoes and fragrant dill.", "Нежный сливочный суп с лососем, картофелем и ароматным укропом."), c("Especial del Chef", "Chef’s special", "ШЕФ рекомендует")),
      item(c("Borscht", "Borscht", "Борщ"), "20 000", c("Borscht tradicional con carne de res y verduras, servido con crema agria y pan Borodinsky.", "Traditional borscht with beef and vegetables, served with sour cream and Borodinsky bread.", "Традиционный борщ с говядиной и овощами, подаётся со сметаной и бородинским хлебом."), c("Especial del Chef", "Chef's special", "От шефа")),
  ...
  {
    id: "parrilla",
    title: c("A la parrilla", "Over an open fire", "Мангал"),
    intro: c("Carnes a las brasas con salsas de la casa", "Charcoal-grilled meats with signature sauces", "Мясо на углях и фирменные соусы"),
    items: [
      ...
      item(c("Entraña a las brasas", "Charcoal-grilled skirt steak", "Стейк «Мачете» (энтранья)"), "54 900", c("Corte tradicional argentino cocinado al fuego, jugoso y lleno de sabor. 550 g.", "Traditional Argentine cut, fire-grilled, juicy and full of flavour. 550 g.", "Самый мужской стейк с ярким мясным вкусом, приготовленный на углях. 550 г."), c("Especial del Chef", "Chef's special", "От шефа")),
      item(c("Mollejas a las brasas", "Charcoal-grilled sweetbreads", "Молехас на углях"), "25 000", c("La joya de la parrilla argentina, cocinada al fuego: dorada por fuera y tierna por dentro. 350 g.", "The jewel of the Argentine grill, charcoal-grilled to perfection: golden outside, tender inside. 350 g.", "Один из главных деликатесов аргентинской парильи: золотистый снаружи и нежный внутри. 350 г."), c("Especial del Chef", "Chef's special", "От шефа")),
      ...
      item(c("Muslo de pollo", "Chicken shashlik", "Куриный шашлык"), "22 000", c("Muslo de pollo deshuesado y marinado en adjika especiada, cocinado a las brasas.", "Boneless chicken thigh marinated in spicy adjika and grilled over charcoal.", "Куриное бедро без кости, выдержанное в пряной аджике и обжаренное на углях.")),
  ...
  {
    id: "casa",
    title: c("Platos de la casa", "Chef’s signature dishes", "Фирменные блюда"),
    intro: c("Platos pensados para compartir", "Signature dishes for a generous table", "Фирменные блюда для щедрого стола"),
    items: [
  ...
  {
    id: "vapor",
    title: c("Al vapor", "Steamed dishes", "На пару"),
    intro: c("Platos tradicionales hechos a mano", "Handmade with care — comforting dishes", "Ручная лепка и любимые блюда с душой"),
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      item(c("Bliny", "Bliny", "Блины"), "12 000", c("Con crema agria, leche condensada o mermelada.", "Served with sour cream, condensed milk or jam.", "Со сметаной, сгущёнкой или джемом."), c("Más pedidos", "Popular", "Популярное")),
      item(c("Papas fritas", "Crispy French fries", "Картофель фри"), "7 000"),
  ...
  },
  {
    ...
    intro: c("Dulces orientales y clásicos", "Eastern sweets and beloved classics for tea", "Восточные сладости и любимая классика к чаю"),
    items: [
      ...
      item(c("Mermeladas", "Jams", "Варенье"), undefined, undefined, undefined, undefined, [
        { label: c("Mermelada de frambuesa", "Raspberry jam", "Варенье малина"), price: "3 000" },
        { label: c("Mermelada de arándanos", "Blueberry jam", "Варенье черника"), price: "3 000" },
      ]),
    ],
  },
  {
    ...
    items: [
      ...
      item(c("Tés de la casa", "House teas", "Фирменные чаи"), undefined, c(
        "Té Masala: té negro intenso preparado con leche, canela, cardamomo y jengibre; especiado, aromático y reconfortante. Té uzbeko: té aromático con jengibre, rodajas de limón y miel natural; refrescante y a la vez reconfortante.",
        "Masala tea: rich black tea brewed with milk, cinnamon, cardamom and ginger; spiced, warming and aromatic. Uzbek tea: fragrant tea with ginger, lemon slices and natural honey; warming and refreshing.",
        "Масала-чай: насыщенный чёрный чай, сваренный с молоком, корицей, кардамоном и имбирём; пряный, согревающий и ароматный. Узбекский чай: ароматный чай с имбирём, ломтиками лимона и натуральным мёдом; согревающий и освежающий.",
      ), undefined, undefined, [
      ...
      item(c("Té — 600 ml", "Tea — 600 ml", "Чай — 600 мл"), undefined, undefined, undefined, undefined, [
        { label: c("Hibiscus", "Hibiscus", "Каркаде"), price: "7 000" }, { label: c("Jazmín", "Jasmine", "Жасминовый"), price: "7 000" }, { label: c("Ulun", "Oolong", "Улун"), price: "7 000" }, { label: c("Té negro", "Black tea", "Чёрный чай"), price: "7 000" }, { label: c("Té negro con menta", "Black tea with mint", "Чёрный чай с мятой"), price: "7 000" }, { label: c("Té de manzanilla", "Chamomile tea", "Ромашковый чай"), price: "7 000" }, { label: "С чабрецом", price: "7 000", languages: ["ru"] },
      ]),
    ],
  },
  {
    ...
    intro: c("Bebidas refrescantes, limonadas caseras y shakes de frutas", "Refreshing drinks, homemade lemonades and fruit shakes", "Освежающие напитки, домашние лимонады и фруктовые шейки"),
    items: [
      ...
      item(c("Shakes de frutas", "Fruit shakes", "Фруктовые шейки"), undefined, undefined, undefined, undefined, [
  ...
  },
  {
    ...
    items: [
      ...
      item(c("Cervezas", "Beer", "Пиво"), undefined, undefined, undefined, undefined, [
        { label: c("Corona Extra — 330 ml", "Corona Extra — 330 ml", "Corona Extra — 330 мл"), price: "6 000" }, { label: c("Stella Artois — 330 ml", "Stella Artois — 330 ml", "Stella Artois — 330 мл"), price: "6 000" }, { label: c("La Paloma 10 Sabores — 475 ml", "La Paloma 10 Flavors — 475 ml", "La Paloma, 10 вкусов — 475 мл"), price: "8 000" },
      ]),
...
export const ui = {
  ...
  ru: {
    ...
    heroTitle: "Вкус Востока",
    heroSubtitle: "в каждом блюде",
    menu: "Меню",
    experiences: "Сеты",
    ...
    discountLabel: "Оплата наличными",
    hours: "ПН – ЧТ 11:00–23:00 / ПТ – ВС 11:00–24:00",
    address: "BONPLAND, 1965",
