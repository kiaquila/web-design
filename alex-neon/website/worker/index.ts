/**
 * Cloudflare Worker entry point for the Alex Neon stage.
 *
 * The landing is fully static: Workers Static Assets serves everything out of
...
/**
 * The page loads nothing from other origins: one local stylesheet, two local
 * scripts, self-hosted fonts and images. `style-src` allows inline because the
